...
export default function MobileToolbarToggle({
  toolbarRef,
  colorPaletteRef,
}: MobileToolbarToggleProps) {
  ...
  return (
    <motion.button
      className="lg:hidden fixed bottom-4 left-4 bg-primary text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg z-20"
